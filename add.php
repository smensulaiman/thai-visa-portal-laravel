...
<div class="container-fluid">
    ...
    <?php
		...
		<?php
			...
			$pythonPath = '"C:\Users\SENDA-2\AppData\Local\Programs\Python\Python313\python.exe '; // Wrap in quotes
			$pythonScriptPath = 'C:/wamp64/www/thai-mvc/pdf/main.py '.$pdf_file.'"';
			
			$output = [];
			echo "<br>";
			echo "$pythonPath $pythonScriptPath ";
			echo "<br>";
			// Execute the Python script
			exec("$pythonPath $pythonScriptPath ", $output, $return_var);
